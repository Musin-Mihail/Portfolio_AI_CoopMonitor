...
{
    /// <inheritdoc />
    public partial class Phase4_SensorsAndLogic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nh3 = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorReadings_HouseId_Date",
                table: "SensorReadings",
                columns: new[] { "HouseId", "Date" });
        }
